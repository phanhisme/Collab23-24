...
public class DraftPM : MonoBehaviour
{
    ...
    private bool dashUnlocked = false; // Flag to check if dash is unlocked
    //end
    Vector3 movement;
    ...
    void Dash()
    {
        ...
        // Ensure the dash ability is unlocked before allowing the player to dash
