...
public class ObjectRoomSpawner : MonoBehaviour
{
    ...
    {
        //maximum value excludes (Random.Range(0,1) -> (Random.Range(0,0) -Unity Documentation
        //thus, +1;
        int randomInteration = Random.Range(data.spawnerData.maxSpawn, data.spawnerData.maxSpawn + 1);
